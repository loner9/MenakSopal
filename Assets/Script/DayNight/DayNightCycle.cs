...
public class DayNightCycle : MonoBehaviour
{
    ...
    public void SetTime(float hour)
    {
        ...
        // Force immediate refresh for URP 2D Global Light if assigned
        if (globalLight2D != null)
        {
            // Just assigning color/intensity usually triggers URP 2D refresh
            // but we'll ensure the values are pushed
            UpdateTimeOfDay();
            ApplyGradualLighting();
        }
    }
