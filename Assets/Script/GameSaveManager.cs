...
public class GameSaveManager : MonoBehaviour
{
    ...
    void ApplySaveDataToSystems(GameSaveData saveData)
    {
        ...
        if (npcInteractionSystem != null && saveData.dialogueData != null)
        {
            ...
            // Sync loaded flags to FlagManager

            if (FlagManager.Instance != null && saveData.dialogueData.gameFlags != null)
            {
                FlagManager.Instance.LoadSaveData(new FlagManager.FlagSaveData
                {

                    flags = saveData.dialogueData.gameFlags
