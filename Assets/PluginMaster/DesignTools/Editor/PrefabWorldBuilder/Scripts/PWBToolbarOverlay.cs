...
#region GRID TOOLS
    ...
    [UnityEditor.Toolbars.EditorToolbarElement(ID, typeof(UnityEditor.SceneView))]
    public class SnapToggle : EditorToolbarDropdownToggle, UnityEditor.Toolbars.IAccessContainerWindow
    {
    ...
    [UnityEditor.Toolbars.EditorToolbarElement(ID, typeof(UnityEditor.SceneView))]
    public class GridToggle : EditorToolbarDropdownToggle, UnityEditor.Toolbars.IAccessContainerWindow
    {
        ...
        public GridToggle()
        {
            ...
            this.RegisterValueChangedCallback(OnValueChange);
            var settings = SnapManager.settings;
            settings.OnDataChanged += () => value = settings.visibleGrid;
        }
