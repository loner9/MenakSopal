...
public class MovementController2D : MonoBehaviour
{
    ...
    void Update()
    {
        if (ControlFreak2.CF2Input.GetMouseButtonDown(0)) //check for a new target
        {
            GetMoveCommand(Camera.main.ScreenToWorldPoint(ControlFreak2.CF2Input.mousePosition));
        }
