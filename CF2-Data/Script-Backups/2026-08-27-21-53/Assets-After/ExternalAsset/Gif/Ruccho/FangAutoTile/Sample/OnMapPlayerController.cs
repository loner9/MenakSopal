...
namespace Ruccho
{
    ...
    public class OnMapPlayerController : MonoBehaviour
    {
        ...
        private void UpdateTarget()
        {
            int x = 0;
            int y = 0;
            x += ControlFreak2.CF2Input.GetKey(KeyCode.RightArrow) ? 1 : 0;
            x += ControlFreak2.CF2Input.GetKey(KeyCode.LeftArrow) ? -1 : 0;
            y += ControlFreak2.CF2Input.GetKey(KeyCode.UpArrow) ? 1 : 0;
            y += ControlFreak2.CF2Input.GetKey(KeyCode.DownArrow) ? -1 : 0;
